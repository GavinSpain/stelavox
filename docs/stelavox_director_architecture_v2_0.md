# Stelavox Director Architecture v2.0

**Status:** Design — supersedes parts of `stelavox_technical_architecture_v2_2.md` §8.
...
**Source decisions:** `docs/sessions/director_v2_deep_dive_session_record_2026-05-11.md`.

# Stelavox Director Architecture v2.6

**Status:** Design + V1.x-B.2 implementation absorption + V1.x-C plan-model + per-org-BYOK + V1.x-D UI substrate + V1.x-E admin dashboard + V1.x-F failure-mode UX absorption — supersedes parts of `stelavox_technical_architecture_v2_3.md` §8 (now v2.9).

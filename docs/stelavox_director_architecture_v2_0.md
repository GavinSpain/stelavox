# Stelavox Director Architecture v2.3

**Status:** Design + V1.x-B.2 implementation absorption + V1.x-C plan-model + per-org-BYOK substrate absorption — supersedes parts of `stelavox_technical_architecture_v2_3.md` §8 (now v2.6).

# Stelavox Director Architecture v2.2

**Status:** Design + V1.x-B.2 implementation absorption — supersedes parts of `stelavox_technical_architecture_v2_3.md` §8 (now v2.4).
